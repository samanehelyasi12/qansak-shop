...
const leftDecor = [
  {
    ...
    className: "left-10 top-[28%] w-14 sm:left-16 sm:w-16 md:left-20 md:w-20 lg:left-28 lg:w-24",
    delay: "0s",
    rotate: "-8deg",
  },
  {
    src: "/images/decor/float-chocolate.webp",
    className: "left-16 top-1/2 w-12 sm:left-24 sm:w-14 md:left-28 md:w-16 lg:left-36 lg:w-20",
    delay: "1.2s",
    rotate: "6deg",
  },
  {
    src: "/images/decor/float-cupcake-liner.webp",
    className: "left-10 top-[68%] w-12 sm:left-16 sm:w-14 md:left-20 md:w-16 lg:left-28 lg:w-20",
    delay: "2.1s",
    rotate: "-4deg",
  },
];
...
const rightDecor = [
  {
    ...
    className: "right-10 top-[28%] w-14 sm:right-16 sm:w-16 md:right-20 md:w-20 lg:right-28 lg:w-24",
    delay: "0.6s",
    rotate: "8deg",
  },
  {
    src: "/images/decor/float-sprinkles.webp",
    className: "right-16 top-1/2 w-12 sm:right-24 sm:w-14 md:right-28 md:w-16 lg:right-36 lg:w-20",
    delay: "1.8s",
    rotate: "-6deg",
  },
  {
    src: "/images/decor/float-cream-bag.webp",
    className: "right-10 top-[68%] w-12 sm:right-16 sm:w-14 md:right-20 md:w-16 lg:right-28 lg:w-20",
    delay: "2.6s",
    rotate: "5deg",
  },
];
        ...
        <div className="pointer-events-none absolute inset-0 hidden md:block">
          {leftDecor.map((item, idx) => (
            <img
              ...
              style={{ animationDelay: item.delay, "--float-rotate": item.rotate } as React.CSSProperties}
            />
          ))}
