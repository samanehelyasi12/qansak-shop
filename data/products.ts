...
export const products: Product[] = [
  {
    ...
    images: ["/images/categories/cake.webp"],
    categorySlug: "cake",
    preparationHours: 24,
    isBestSeller: true,
    isNew: false,
  ...
  },
  {
    ...
    price: 720000,
    images: ["/images/categories/cheesecake.webp"],
    categorySlug: "cake",
    preparationHours: 24,
    isBestSeller: false,
    isNew: true,
  ...
  },
  {
    ...
    price: 45000,
    images: ["/images/categories/cafe-cake.webp"],
    categorySlug: "cafe-cake",
    preparationHours: 4,
    isBestSeller: true,
    isNew: false,
    inStock: true,
  ...
  },
  {
    ...
    price: 55000,
    images: ["/images/categories/tiramisu.webp"],
    categorySlug: "cafe-cake",
    preparationHours: 4,
    isBestSeller: false,
    isNew: true,
  ...
  },
  {
    ...
    price: 320000,
    images: ["/images/categories/cookie.webp"],
    categorySlug: "cookie",
    preparationHours: 12,
    isBestSeller: true,
    isNew: false,
  ...
  },
  {
    ...
    price: 380000,
    images: ["/images/categories/sable.webp"],
    categorySlug: "cookie",
    preparationHours: 12,
    isBestSeller: false,
    isNew: false,
  ...
  },
  {
    ...
    price: 65000,
    images: ["/images/categories/bread.webp"],
    categorySlug: "bread",
    preparationHours: 6,
    isBestSeller: true,
    isNew: true,
  ...
  },
  {
    ...
    images: ["/images/categories/candy.webp"],
    categorySlug: "candy",
    preparationHours: 8,
    isBestSeller: true,
    isNew: false,
